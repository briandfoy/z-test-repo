...
=head1 The Foo module

This is the I<README> for the L<Foo> Perl module.
...
To read about L<Foo>, look at the embedded documentation
...
L<MetaCPAN|http://www.metacpan.org/pod/Foo>.
...
the source repository: L<https://github.com/briandfoy/z-test-repo>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/z-test-repo/issues>.
...
=item * L<https://bitbucket.com/briandfoy/z-test-repo>

=item * L<https://codeberg.org/briandfoy/z-test-repo>

=item * L<https://gitlab.com/briandfoy/z-test-repo>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Foo-1.23.tar.gz --owner briandfoy
